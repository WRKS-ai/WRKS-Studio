...
// PixelBlast — TypeScript port of the React Bits PixelBlast component
// (itself inspired by github.com/zavalit/bayer-dithering-webgl-demo).
//
// Bayer-dithered noise field rendered into one of four pixel shapes
// (square / circle / triangle / diamond) with optional ripple-on-click
// + liquid-distort + noise-overlay effects.
//
// Shader is GLSL3 (WebGL2 only — uses `out vec4 fragColor`). We render
// into an absolutely-positioned canvas inside the host div; the host
// takes 100% of its parent.
